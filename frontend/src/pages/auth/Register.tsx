...
export default function Register() {
  ...
  const inputClass =
    "w-full pl-10 pr-4 py-3 border-2 rounded-lg border-orange-200 focus:border-teal-500 focus:outline-none transition-colors"
  const inputClassWithToggle =
    "w-full pl-10 pr-12 py-3 border-2 rounded-lg border-orange-200 focus:border-teal-500 focus:outline-none transition-colors"
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-teal-600 to-emerald-600 p-8 text-center">
            ...
            <p className="text-teal-50">Join our shopping community</p>
          </div>
          ...
          <div className="p-8 max-h-[calc(100vh-8rem)] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <label className="flex items-start gap-2 text-sm text-gray-600">
                <input type="checkbox" className="w-4 h-4 rounded cursor-pointer mt-0.5 shrink-0" required />
                <span>
                  I agree to the{" "}
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          © {new Date().getFullYear()} canim ecommerce. All rights reserved.
        </p>
      </div>
    </div>
  )
