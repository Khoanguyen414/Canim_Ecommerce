...
const SLIDES: HeroSlide[] = [
  {
    ...
    description:
      "Hàng tươi, giá rõ ràng theo từng loại, thanh toán an toàn và hỗ trợ nhanh khi bạn cần.",
  },
  {
    id: "delivery",
    badge: "Fast & reliable",
  ...
  },
  {
    ...
    description:
      "Nhiều lựa chọn size và quy cách — luôn biết còn hàng hay không trước khi thêm vào giỏ.",
  },
]
