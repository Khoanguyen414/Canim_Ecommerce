...
public class WarehouseController {
    ...
    // QUAN TRỌNG: Dùng Interface WarehouseService để Spring tự tìm Impl
    ...
    public ResponseEntity<InputStreamResource> exportInventory() throws IOException {
        ByteArrayInputStream in = warehouseService.exportInventoryToExcel();
        String filename = "bao_cao_ton_kho.xlsx";
